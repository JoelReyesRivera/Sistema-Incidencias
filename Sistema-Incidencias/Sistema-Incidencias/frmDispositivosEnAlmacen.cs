...
{
    public partial class frmDispositivosEnAlmacen : Form
    {
        public frmDispositivosEnAlmacen()
        {
            InitializeComponent();
        }

        private void frmDispositivosEnAlmacen_Load(object sender, EventArgs e)
        {
            ...
            string Query = "SELECT * FROM  VW_DispositivosAlmacenados";
