...
{
    public partial class frmConsultaDispositivoIncidencia : Form
    {
        public frmConsultaDispositivoIncidencia()
        {
            InitializeComponent();
        }

        private void frmConsultaDispositivoIncidencia_Load(object sender, EventArgs e)
        {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string Query = "SELECT ID_INCIDENCIA,INCIDENCIA,REPORTADO_POR,FECHA_REPORTE,FECHA_SOLUCION,SOLUCIONADO_POR,TIPO_SOLUCION FROM VW_IncidenciasConcluidas WHERE DISPOSITIVO = " + comboBox1.SelectedItem.ToString();
            SqlDataReader Lector = null;
            Lector = UsoBD.Consulta(Query, Conecta);
            if (Lector == null)
            {
