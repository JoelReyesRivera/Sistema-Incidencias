...
--Creacion de incidencia 
 insert into DISPOSITIVO values('ABC123',1,'2021-05-20','DELL01', 'DELL ROJA',1,1)
 insert into DISPOSITIVO values('LENOVO',1,'2021-05-20','DELL01', 'DELL ROJA',1,1)
  select * from DISPOSITIVO

  INSERT INTO INCIDENCIA values('ABC123','NO MUESTRA IMAGEN','GMARIANA',0,'2020-12-3')
  INSERT INTO INCIDENCIA values('ABC123','FALLA MEMORIA','GMARIANA',0,'2020-12-3')
  INSERT INTO INCIDENCIA values('LENOVO', 'FALLA CONEXION INTERNET','PJAZMIN',0,'2020-12-16')
  INSERT INTO INCIDENCIA values ('LENOVO', 'SIN SONIDO','PJAZMIN',0,'2020-12-16')


  INSERT INTO INCIDENCIA_TECNICO VALUES(1,'FERNANDO','FELIPE','2020-12-4')
  INSERT INTO INCIDENCIA_TECNICO VALUES(2,'FERNANDO','JUAN','2020-12-4')


CREATE VIEW VW_IncidenciasTecnico
WITH ENCRYPTION
AS
SELECT IT.TECNICO,I.ID,I.DISPOSITIVO,M.NOMBRE AS MARCA,D.MODELO,A.DESCRIPCION AS UBICADO,I.DESCRIPCION AS INCIDENCIA,I.REPORTADO_POR,FORMAT(I.FECHA_REPORTE,'dd/MMM/yyy') as FECHA_REPORTE,FORMAT(IC.FECHA_SOLUCION,'dd/MMM/yyy') as FECHA_SOLUCION, E.DESCRIPCION AS ESTATUS, ic.SOLUCIONADO_POR FROM INCIDENCIA I
INNER JOIN ESTATUS E ON I.ESTATUS = E.ID
INNER JOIN DISPOSITIVO D ON I.DISPOSITIVO = D.NUMERO_SERIE
INNER JOIN MARCA M ON M.ID = D.MARCA
INNER JOIN AULA A ON D.AULA = A.ID
...
SELECT * FROM VW_IncidenciasTecnico WHERE ID=4