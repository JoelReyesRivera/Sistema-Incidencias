...
VALUES (385712095,2,GETDATE(),'COMPAQ','LAPTOP',1,2)

INSERT INTO DISPOSITIVO
VALUES (825723598,1,GETDATE(),'ASUS','PC',2,4)

INSERT INTO DISPOSITIVO
VALUES (385712565,2,GETDATE(),'LENOVO','LAPTOP',1,2)
...
WITH ENCRYPTION
AS
SELECT C.ID, C.ID_INCIDENCIACONCLUIDA,C.ID_ANTIGUOCOMPONENTE,C.ID_NUEVOCOMPONENTE, FORMAT(IC.FECHA_SOLUCION,'dd/MMM/yyy') AS FECHA_CAMBIO FROM CAMBIO_COMPONENTE C
...
EXEC SPFinalizaIncidencia 2,JUAN,1,'385712565'
