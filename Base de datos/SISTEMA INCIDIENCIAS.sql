...
CREATE TABLE JEFE_DEPARTAMENTO (
	USUARIO INT PRIMARY KEY FOREIGN KEY REFERENCES USUARIO (MATRICULA),
	EDIFICIO VARCHAR(10),
	AULA VARCHAR(10),
...
CREATE TABLE AULA (
	...
	JEFE_DEPARTAMENTO INT FOREIGN KEY REFERENCES JEFE_DEPARTAMENTO (USUARIO) 
)
...
CREATE TABLE INCIDENCIA (
	ID TINYINT PRIMARY KEY,
	REPORTADO_POR INT FOREIGN KEY REFERENCES JEFE_DEPARTAMENTO (USUARIO) NOT NULL,
...
CREATE TABLE DETALLE_INCIDENCIA(
	...
	SOLUCIONADO_POR INT FOREIGN KEY REFERENCES TECNICO (USUARIO) NOT NULL,
